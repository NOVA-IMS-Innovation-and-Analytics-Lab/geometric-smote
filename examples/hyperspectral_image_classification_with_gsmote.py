...
print("n_features:'%s', n_samples: '%s', Ratio: '%s'" %
...
# parameters for the classifier and oversampler. For model validation 5fold 
# cross-validation is used. FScore measure is implemented to evaluate the 
